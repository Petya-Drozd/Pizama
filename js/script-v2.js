...
document.addEventListener("DOMContentLoaded", () => {
	let a;
	const arrDate = [
	  'Mar 15 2025 02:48:40',
	  'May 15 2025 02:49:10',
	  'Jun 15 2025 02:50:19',
	  'Jul 15 2025 01:40:00',
	];
    let newYear = new Date(arrDate[0]);
  ...
  function howLong() {
    ...
    let dateUntil = (newYear - nowDate);
  	...
  	if (dateUntil < 0) {
		  result = arrDate.find(item => {
			  if (new Date(item).getTime() > new Date()) {
